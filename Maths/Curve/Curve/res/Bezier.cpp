...
void GetCurve(sf::VertexArray& curve, sf::Vector2f p1, sf::Vector2f p2, sf::Vector2f p3, sf::Vector2f p4)
{
    ...
    for (int i = 0; i < pointsCount; i++)
    {
        ...
        sf::Vector2f p23 = LerpVector(p2, p3, t);
        sf::Vector2f p34 = LerpVector(p3, p4, t);
        sf::Vector2f p13 = LerpVector(p12, p23, t);
        sf::Vector2f p24 = LerpVector(p23, p34, t);

        curve[i].position = LerpVector(p13, p24, t);
        curve[i].color = LerpColor(sf::Color::Cyan, sf::Color::Magenta, t);
